...
import { Send, Lock, Users, MessageCircle } from "lucide-react";
...
export default function AdminChatPage() {
  ...
  // Password check (simple, client-side only)
  ...
  useEffect(() => {
    if (!authenticated || !selectedUserId) return;
    const q = query(
      collection(db, "chats"),
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-gray-950">
      {/* Sidebar user list */}
      <div className="w-full md:w-80 bg-gray-900 border-r border-gray-800 p-6 flex flex-col gap-4">
